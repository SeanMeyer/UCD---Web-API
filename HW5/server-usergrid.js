    ...
    client.getEntity(properties, function (error, result) {
        if (error) {
            ...
            if (reviews != "true") {
                ...
                //var message = [];
                //message.push(formatMovieResult(result._data));
                var message = formatMovieResult(result._data);
                var properties = {
                    method:'GET',
                    type:'review',
                    name:title
                ...
                client.getEntity(properties, function (error, result) {
                    //message.push(formatReview(result._data));
                    message['reviews'] = formatReview(result._data);
                    res.send(message);
                });
            }
        }
